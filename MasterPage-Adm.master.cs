...
public partial class MasterPage_Adm : System.Web.UI.MasterPage
{
    private int codigo, dia2, mes2, ano2, cont;
    private string email, cpf, palavra, senha, senha2, data, mensagem, msg, novaSenha, username;
    private char letra;
    ...
    protected void btnOk_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //Para comparar de maneira correta
            ...
            if (!ValidarSenhaAtual(usuSenha)) //senha certa
            {
                ...
                switch (db.UpdateSenhaPerfil(usuSenha))
                {
                    case true:
                        ...
                        Page.ClientScript.RegisterStartupScript(this.GetType(), "script", "<script>swal('Bom trabalho!','Sua senha foi alterada com sucesso! Enviamos um email com a nova senha para você.','success');</script>", false);
                        txtSenhaAntiga.Text = "";
                        txtSenhaNova.Text = "";
                        txtRepitaSenha.Text = "";
